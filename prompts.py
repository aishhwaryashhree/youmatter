...
#
# TOPIC_PLAYBOOKS = topic-specific scripts, only injected when classify_topic()
# (in ai_core.py) detects that topic is actually relevant to the message.
# Wording is unchanged from the original prompt — this file only reorganizes
# where the content lives, it doesn't rewrite any of it.
